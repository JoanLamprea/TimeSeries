...
tipos88 <- read.table("C:/Users/Personal/Downloads/TimeSeries-master/Series Univariadas/Bases de Datos/Estacionarias/tipos88.dat", quote="\"", comment.char="")
...
ARPURO_fixed=stats::arima(sercamrelint,order=c(3,0,0),include.mean = FALSE,fixed=c(NA,0,NA),method = c("CSS-ML"),transform.pars = FALSE)
